import '../customized_html_editor.dart';
import '../src/widgets/html_editor_widget_web.dart';
...
class HtmlEditor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (kIsWeb) {
      ...
      return Text('Non-Flutter Web environment detected, please make sure you are importing package:customized_html_editor/html_editor.dart');
    }
  }
}
