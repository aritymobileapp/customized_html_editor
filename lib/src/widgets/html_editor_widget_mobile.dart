...
import 'package:customized_html_editor/customized_html_editor.dart' hide NavigationActionPolicy, UserScript, ContextMenu;
                  ...
                  onLoadStop: (InAppWebViewController controller, Uri? uri) async {
                    ...
                    if (url.contains(filePath)) {
                      ...
                      await controller.evaluateJavascript(
                          source: "document.getElementsByClassName('note-editable')[0].setAttribute('inputmode', '${describeEnum(widget.htmlEditorOptions.inputType)}');");
