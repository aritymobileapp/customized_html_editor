import '../customized_html_editor.dart' hide HtmlEditorController;
import '../src/html_editor_controller_mobile.dart';
import '../src/widgets/html_editor_widget_mobile.dart';
...
class HtmlEditor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (!kIsWeb) {
      ...
      return Text('Flutter Web environment detected, please make sure you are importing package:customized_html_editor/html_editor.dart');
    }
  }
}
